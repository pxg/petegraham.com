...
After getting slightly frustrated with having to edit myself on the MacBook, I installed [Wispr Flow](https://wisprflow.ai/), which is speech-to-text software from a startup called Wispr. It cleans up mistakes. I believe it runs local models but also connects to cloud-based models, and it does this as you speak and is incredibly performant. It feels almost instant. There are open-source alternatives, but I've not tried them yet.
...
I use [Claude Code](https://claude.ai/code) quite frequently. It has its own built-in voice input. I found this a bit fiddly, tried it a few times, and just fell back to dictating as I would for any other input.
