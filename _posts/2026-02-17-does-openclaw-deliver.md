...
The concept is fairly simple you use a messaging service such as WhatsApp, Signal or Telegram to talk to your OpenClaw instance, this can either run on hardware you own such as your laptop or a Mac Mini, or a cloud server. OpenClaw is then powered by an LLM, it started with just support for Anthropic's Claude, but now support many different models such as Google Gemini and OpenAI's GPT models.
...
For sometime I've wanted an AI based TaskAI manager, I started vibe coding one last year, I still have the domain TaskAI.it gathering dust, at the time I found LLMs weren't quite ready to automate many of the tasks I wanted. With projects like OpenClaw it feels like AI may be ready to deliver on this promise. 
...
I decided to give it a spin to see what it could do. I've opted to install it on a Cloud Server as this felt the safest. Virtualisation with [UTM](https://mac.getutm.app/) could also have been good approach.
...
I then configured OpenClaw/Josh to work with a Signal bot, I which I got working after quite a bit of messing about. I did find that OpenClaw sometimes hung or didn't reply to messages, it definitely didn't feel a robust experience.
